        ...
        <div className="bridge-panel bridge-panel-bio module1-panel module1-soft-panel">
          ...
          <div className="bridge-visual bridge-visual-bio">
            <svg viewBox="0 0 860 420" role="img" aria-label="Biological neuron diagram">
              ...
              <g data-part="soma" className="bridge-bio__soma">
                <path
                  d="
                    M 280 250
                    C 270 220, 300 200, 340 210
                    C 380 220, 400 250, 390 285
                    C 375 320, 330 330, 300 305
                    C 270 285, 265 265, 280 250
                    Z
                  "
                />
              </g>

              <g data-part="nucleus" className="bridge-bio__nucleus">
                <ellipse cx="330" cy="265" rx="14" ry="11" />
                <circle cx="335" cy="265" r="4" />
              </g>

              <g data-part="hillock" className="bridge-bio__hillock">
                <path
                  d="
                    M 390 250
                    C 410 245, 420 255, 420 265
                    C 420 275, 410 285, 390 280
                    Z
                  "
                />
              </g>

              <g data-part="axon" className="bridge-bio__axon">
                <path d="M 420 265 C 520 255, 600 260, 680 270" />
              </g>

              <g data-part="terminal" className="bridge-bio__terminal">
