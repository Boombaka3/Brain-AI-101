        ...
        <div className="m3-brain-feedback__layout">
          ...
          <div className="m3-brain-feedback__visual">
            ...
            <p className="m3-source-note">
              Live demo shown from Axel Wickman&apos;s NeuroCorrelation article. Local browser build support can be added later when the generated runtime files exist on this machine.
            </p>
          </div>
        </div>
      </div>
